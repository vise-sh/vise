...
#[openapi(
    ...
    paths(
        ...
        crate::routes::routines::create_routine,
        crate::routes::routines::list_routines,
        crate::routes::routines::get_routine,
        crate::routes::routines::update_routine,
        crate::routes::routines::delete_routine,
        crate::routes::routines::run_routine,
        crate::routes::routines::list_routine_runs,
    ...
    components(schemas(
        ...
        crate::routes::routines::CreateRoutineRequest,
        crate::routes::routines::UpdateRoutineRequest,
        crate::routes::routines::ListRoutinesResponse,
        crate::routes::routines::ListRunsResponse,
        vise_core::routines::model::Routine,
        vise_core::routines::model::SessionSpec,
